...
# FILENAME: cnn.py
# SPECIFICATION: Build a CNN that will classify digits.
# FOR: CS 4210 - Assignment #4
# TIME SPENT: Roughly an hour
#-------------------------------------------------------------------------
...
# --> add your Python code here
X_train = np.array([image_array / 255 for image_array in X_train])
X_test = np.array([image_array / 255 for image_array in X_test])
